...
VIDEO_STABILITY_FRAMES: Final[int] = 8  # Frames a slot must keep a state before it changes
SLOT_INNER_MARGIN: Final[float] = 0.15  # Ignore slot borders when matching vehicles
VEHICLE_SLOT_OVERLAP: Final[float] = 0.15  # Minimum vehicle overlap with slot interior
